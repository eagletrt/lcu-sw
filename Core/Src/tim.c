...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *timHandle) {
    ...
    PA5     ------> TIM1_CH1
    */
        GPIO_InitStruct.Pin = BLUE_GATE_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF5_TIM1;
        HAL_GPIO_Init(BLUE_GATE_GPIO_Port, &GPIO_InitStruct);
    ...
    PA7     ------> TIM3_CH2
    */
        GPIO_InitStruct.Pin = GREEN_GATE_Pin | RED_GATE_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void tim_brake_update(bool actuated) {
    const uint32_t duty_cycle = actuated ? (htim14.Instance->ARR + 1) : 0;
